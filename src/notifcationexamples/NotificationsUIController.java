...
public class NotificationsUIController implements Initializable, Notifiable {
    ...
    @Override
    public void notify(String message, RunningState runningState) {
    ...
    public void startTask2(ActionEvent event) {
        ...
        if (task2 == null) {
            ...
            task2.setOnNotification((String message, RunningState runningState) -> {
                if (runningState == RunningState.NOTRUNNING) {
                    task2 = null;
    ...
    public void startTask3(ActionEvent event) {
        ...
        if (task3 == null) {
            ...
            task3.addPropertyChangeListener("message", (PropertyChangeEvent evt) -> {
                textArea.appendText((String)evt.getNewValue() + "\n");
                
            });
            task3.addPropertyChangeListener("state", (PropertyChangeEvent evt) -> {
                
                if (RunningState.NOTRUNNING == evt.getNewValue()) {
                    task3 = null;
            ...
            task3.end();
            task3 = null;
            task3Button.setText("Start Task 2");
        }
    } 
}
